...
export default function Values() {
  ...
  return (
    <section id="nosotros" style={{ padding: '100px 24px', position: 'relative', overflow: 'hidden' }}>
      {/* ambient glow */}
      <div style={{ position: 'absolute', left: -100, top: '50%', width: 500, height: 500, borderRadius: '50%', background: 'rgba(37,99,235,0.05)', filter: 'blur(80px)', transform: 'translateY(-50%)', pointerEvents: 'none' }} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'center' }} className="values-grid">
          ...
          >
            ...
            >
              ...
              <div>
                <div style={{ fontFamily: 'Syne, sans-serif', fontSize: 22, fontWeight: 800, background: 'linear-gradient(135deg, #2563EB, #60A5FA)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>+20 años</div>
          ...
          <div ref={ref}>
            <motion.div initial={{ opacity: 0, y: 16 }} animate={inView ? { opacity: 1, y: 0 } : {}}
              style={{ display: 'inline-block', background: 'rgba(37,99,235,0.1)', border: '1px solid rgba(37,99,235,0.25)', color: '#2563EB', fontSize: 11, fontWeight: 700, padding: '6px 16px', borderRadius: 100, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: 20 }}
            >
              Por qué elegirnos
            </motion.div>
            ...
            >
              Fabricamos con{' '}
              <span style={{ background: 'linear-gradient(135deg, #2563EB, #60A5FA)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>precisión</span>{' '}
              y pasión
            </motion.h2>
